...
describe('Service Tests', () => {
  describe('Company routing resolve service', () => {
    ...
    let resultCompany: ICompany | undefined;
    ...
    describe('resolve', () => {
      it('should return ICompany returned by find', () => {
        ...
        expect(resultCompany).toEqual({ id: 'ABC' });
      });

      it('should return new ICompany if id is not provided', () => {
        // GIVEN
        ...
        expect(resultCompany).toEqual(new Company());
      });
